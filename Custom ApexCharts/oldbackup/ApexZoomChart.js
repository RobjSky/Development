        ...
        null, {
            ...
            plot: function () {
                ...
                function renderGraph() {
                    ...
                    var prores = []; // define our array
                    for (var i = 0; i < 2; i++) { // loop 10 times
                        prores.push(prompt('Enter grade ' + (i + 1))); // push the value into the array
                    }
                    alert('Full array: ' + prores.join(',')); // alert the results
                    ...
                    var options = {
                        ...
                        xaxis: {
                            ...
                            type: 'datetime',
                            //'2018-09-24T00:00:00',
                            //categories: ['2018-09-24T00:00:00', '2018-09-25T00:00:00'],
                            categories: prores,
                            /*
                    ...
                    alert('Full categories: ' + options.xaxis.categories)
