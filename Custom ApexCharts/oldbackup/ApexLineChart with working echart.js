...
(function () {
    ...
    mstrmojo.plugins.ApexLineChart.ApexLineChart = mstrmojo.declare(
        ...
        null,
        {
            ...
            externalLibraries: [
                //{url: (mstrApp.getPluginsRoot && mstrApp.getPluginsRoot() || "../plugins/") + "ApexLineChart/javascript/mojo/js/source/apexcharts.js"}
                {url: (mstrApp.getPluginsRoot && mstrApp.getPluginsRoot() || "../plugins/") + "ApexLineChart/javascript/mojo/js/source/echarts.min.js"}
            ],
