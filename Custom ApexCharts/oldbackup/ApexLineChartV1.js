            ...
            plot: function () {
                ...
                function prepareData() {
                    ...
                    for (i = 0; i < dp.getTotalRows(); i++) {
                        ...
                        //var attributename = dp.getRowTitles().getTitle(i).getName(); // ANCHOR :NEW
                        var c = [],
                            attributesValue = "";
                        ...
                        for (a = 0; a < dp.getRowHeaders(i).size(); a++) {
                            ...
                            window.alert('getattrname: ' + dp.getRowHeaders(i).getHeader(a).getName()); // ANCHOR :NEW
                            
                            //dataobject.attrnamevalues.push(attributesValue) // ANCHOR :NEW
                        }
                        c[0] = {
                            "v": attributesValue
                        };
...
*/
                    ...
                    //var Say2 = 'Stringify testing: ' + JSON.stringify(datatb.attrnames); // ANCHOR :NEW
