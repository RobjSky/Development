(function () {
    ...
    if (!mstrmojo.plugins.ApexBrushChart) {
        mstrmojo.plugins.ApexBrushChart = {};
    }
    ...
    mstrmojo.plugins.ApexBrushChart.ApexBrushChart = mstrmojo.declare(
        ...
        null, {
            ...
            scriptClass: 'mstrmojo.plugins.ApexBrushChart.ApexBrushChart',
            // Define the CSS class that will be appended to container div
            cssClass: "ApexBrushChart",
           ...
           // ANCHOR CUSTOM PROPERTIES            
            updateLabelSize: function (labelsize) {
                    ...
                    window.alert('ITSA YOU! ' + this.ApexBrushChart);
