(function () {
	...
	var $WT = mstrmojo.vi.models.editors.CustomVisEditorModel.WIDGET_TYPE,
		APLC_PROPERTIES = mstrmojo.plugins.ApexLineChart.APLC_PROPERTIES;

	mstrmojo.plugins.ApexLineChart.ApexLineChartEditorModel = mstrmojo.declare(
		mstrmojo.vi.models.editors.CustomVisEditorModel,
		null, {
			scriptClass: "mstrmojo.plugins.ApexLineChart.ApexLineChartEditorModel",
			cssClass: "ApexLineCharteditormodel",
