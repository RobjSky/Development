...
(function () {
    ...
    if (!mstrmojo.plugins.MyMstrVisECharts) {
        mstrmojo.plugins.MyMstrVisECharts = {};
    }
    // Custom mojo visualizations require the CustomVisBase library to render
    mstrmojo.requiresCls("mstrmojo.CustomVisBase");
    // Declare the visualization object
    mstrmojo.plugins.MyMstrVisECharts.MyMstrVisECharts = mstrmojo.declare(
        ...
        null,
        {
            ...
            scriptClass: 'mstrmojo.plugins.MyMstrVisECharts.MyMstrVisECharts',
            // Define the CSS class that will be appended to container div
            cssClass: "mymstrvisecharts",
            ...
            externalLibraries: [
                {url: (mstrApp.getPluginsRoot && mstrApp.getPluginsRoot() || "../plugins/")+"MyMstrVisECharts/javascript/mojo/js/source/echarts.min.js"}
            ],
