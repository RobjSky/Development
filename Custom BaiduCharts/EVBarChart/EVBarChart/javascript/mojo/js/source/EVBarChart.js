        ...
        null,
        {
            ...
            plot: function () {
                ...
                // 1A:2M -------------------------------------------------------------------------- 1 Attributes and 2 Metrics:
                     ...
                     var option = {
                         ...
                         series: [{
                             ...
                             //data: getArrayData(di, attributeNames, metricNames)
                             data: getArrayData(di, attributeNames, [metricNames[0]]) //Karina's change
                             ...
                             //data: getArrayData(di, attributeNames, metricNames)
                             data: getArrayData(di, attributeNames, [metricNames[1]]) //Karina's change
                ...
                function getArrayData(dataInterface, attributes, metrics, restrict) {
                    ...
                    // Output for debugging - total rows
//                    window.alert('total rows ' + dataInterface.getTotalRows());
//                    window.alert('size row titles ' + dataInterface.getRowTitles().size());
//                    window.alert('metric length ' + metrics.length);
                    //
                    //+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
