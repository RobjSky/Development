    ...
    mstrmojo.plugins.AZoomableDateTime.AZoomableDateTime = mstrmojo.declare(
        ...
        null, {
            ...
            plot: function () {
                ...
                ;
                (me.getProperty("showDebugMsgs") == 'true') ? window.alert('Version 1.054') : 0;
                ...
                // date-based X-Axis:
                    ...
                    //Data Grouping
                    if (me.getProperty("enableDataGrouping") === 'true') {
                ...
                function createSeries(field, name, hiddenInLegend) {
                    ...
                    (me.getProperty("showDebugMsgs") == 'true') ? window.alert('104: j set'): 0;
                ...
                if (me.getProperty("showLegend") === 'true') {
                    ...
                    if (me.getProperty("padLegend") === 'true') {
                        ...
                        if (me.getProperty("sizeMarkerLegend") === 'true') {
                            window.alert('Test: ' + me.getProperty("sizeMarkerLegendAmount"));
