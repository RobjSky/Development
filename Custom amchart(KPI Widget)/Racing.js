...
chart.data = [{ name: "Chandler", file: "/wp-content/uploads/assets/timeline/chandler.jpg", track: 1, value: 450 }, { name: "Ross", file: "/wp-content/uploads/assets/timeline/ross.jpg", track: 2, value: 650 }, { name: "Joey", file: "/wp-content/uploads/assets/timeline/joey.jpg", track: 3, value: 578 }];
...
valueAxis.min = 0;
valueAxis.max = 1000;
valueAxis.renderer.points = [{ x: 0, y: -100 }, { x: 200, y: 0 }, { x: 0, y: 100 }, { x: -200, y: 0 }, { x: 0, y: -100 }];
